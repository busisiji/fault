...
class modbus_tcp_toolkit():
    ...
    def readHoldRegister(self, slave_id_int=1, first_register_id_int=0, register_num_int=0):
        try:
            return self.master.execute(slave_id_int, modbus_define.READ_HOLDING_REGISTERS, first_register_id_int,
                                       register_num_int)
        except:
    ...
    def readInputRegister(self, slave_id_int=1, first_register_id_int=0, register_num_int=0):
        try:
            return self.master.execute(slave_id_int, modbus_define.READ_INPUT_REGISTERS, first_register_id_int,
                                       register_num_int)
        except:
    ...
    def readDiscreteRegister(self, slave_id_int=1, first_register_id_int=0, register_num_int=0):
        try:
            self._is_connected = True
            return self.master.execute(slave_id_int, modbus_define.READ_DISCRETE_INPUTS, first_register_id_int,
                                       register_num_int)
        except:
            self._is_connected = False
    ...
    def writeSingleHoldRegister(self, slave_id_int=1, first_register_id_int=0, register_value_int=0):
        try:
            self.master.execute(slave_id_int, modbus_define.WRITE_SINGLE_REGISTER, first_register_id_int,
                                output_value=regiter_value_int)
        except:
    ...
    def writeSingleCoilRegister(self, slave_id_int=1, first_register_id_int=0, register_value_int=0):
        try:
            self.master.execute(slave_id_int, modbus_define.WRITE_SINGLE_COIL, first_register_id_int,
                                output_value=register_value_int)
        except:
            print("writeSingleCoilRegister fail...")

    def writeMultipleHoldRegister(self, slave_id_int=1, first_register_id_int=0,
                                  register_value_int_arrary=[0, 0, 0, 0, 0, 0, 0, 0]):
        try:
            self.master.execute(slave_id_int, modbus_define.WRITE_MULTIPLE_REGISTERS, first_register_id_int,
                                output_value=register_value_int_arrary)
        except:
            print("writeMultipleHoldRegister fail...")

    def writeMultipleCoilRegister(self, slave_id_int=1, first_register_id_int=0,
                                  register_value_int_arrary=[0, 0, 0, 0, 0, 0, 0, 0]):
        try:
            self.master.execute(slave_id_int, modbus_define.WRITE_MULTIPLE_COILS, first_register_id_int,
                                output_value=register_value_int_arrary)
        except:
